...
$LANG['resp_traite_user_demande_deja_traite'] = "WARNING, demande déjà traitée par ailleurs" ; 
...
$LANG['admin_verif_login_exist_annuaire']  = "ATTENTION : login inexistant dans l'annuaire, veuillez chosir un utilisateur agréé ...";
...
$LANG['admin_users_is_gest']			= "is_gest";// modif du 27 nov 2012
$LANG['admin_users_see_all']			= "see_all";
$LANG['admin_users_has_int_calendar']		= "calendar";
...
$LANG['admin_new_users_is_gest']		= "est_gestionnaire";// modif du 27 nov 2012
...
// page gestion groupe <-> users
$LANG['admin_gestion_groupe_users_none']	= "aucun droit";
...
$LANG['config_comment_titre_application']	= "Titre générique de l'application";
$LANG['config_comment_titre_calendrier']	= "Titre de la page calendrier";
...
$LANG['config_comment_check_user_in_ldap']	= "// Contrôle des Users depuis LDAP :<br>\n//--------------------------------<br>\n// si = TRUE : les users doivent impérativement être référencés dans l'annuaire<br>\n// si = FALSE  : on peut forcer la creation d'1 login non référencé";
...
$LANG['config_comment_mail_echange_rtt_alerte_resp']	= "// ENVOI DE MAIL AU RESPONSABLE POUR UN ECHANGE DE RTT :<br>\n//----------------------------------------------------------<br>\n// si à FALSE : le responsable ne reçoit pas de mail lors d'un nouvel échange de rtt par un utilisateur (TRUE est la valeur par defaut)<br>\n// si à TRUE : le responsable reçoit un mail d'avertissement à chaque nouvel échange de rtt d'un utilisateur\n";
...
$LANG['echange_rtt_saisir_adeplacer']	= "sélection de la date à modifier";
$LANG['echange_rtt_saisir_souhaite']	= "sélection de la date souhaitée";
$LANG['hp_octroi'] = "jour(s) octroyé(s)" ;
$LANG['hp_titre'] = "jours hors période" ;
$LANG['hp_regle'] = "Rappel: si total&#8805;8 hp=2, si 5&#8804;total&#8804;7 hp=1 sinon hp=0 !" ;  
// &#8804; vaut <= &#8805; vaut >=
$LANG['hp_msg_nouveau_solde'] = " comme nouveau solde, pensez à valider " ;
$LANG['hp_msg_hp_controle']   = "nombre de jours hors période est entre 0 et 2" ; 
$LANG['hp_libel_jeligible'] = "Total congés pris hors période" ;
$LANG['hp_libel_solderestant'] = "solde restant" ; 
$LANG['hp_libel_total'] = "total" ; 
...
$LANG['mail_echange_rtt_comment']			= "message d'alerte au responsable en cas d'échange de rtt.";//ajouté le 03/09/09 par SA
...
//autovalidation des congés par le responsable
$LANG['config_comment_autovalidation_conges_par_responsable']	= "// AUTOVALIDATION DES CONGES PAR LE RESPONSABLE : <br>\n//--------------------------------------------------------------------------------------------<br>\n// si à FALSE : le responsable ne peut pas valider ses propres demandes de congés (FALSE est la valeur par defaut)<br>\n// si à TRUE : le responsable peut valider.";
/***********************/ // modif ajout du 26 oct 2012
// _ac3_
/*  $LANG[''] = "// <br>
// <br>" ;  */
...
$LANG['config_comment_date_forcee'] = "// permet de forcer application a utiliser une autre date que la date du jour <br>// a saisir sous la forme 2015-05-01 " ; 
$LANG['config_comment_inclus-selecteur-we'] = "// pour la saisie conge, affiche ou pas une case à cocher permettant de sélectionner les week-ends" ;
$LANG['config_comment_moisjour-debutete'] = "// début période estivale (jours pris ne compte pas pour les jours hors-période) sous la forme 05-01 " ;  
$LANG['config_comment_moisjour-finete'] = "// fin période estivale (jours pris ne compte pas pour les jours hors-période) sous la forme 10-31" ;  
$LANG['config_comment_moisjour-finanneereel'] = "// fin année réel sous la forme 12-31 " ;  
$LANG['config_comment_jourshorsperiode'] = "// booleen - True si jours hors périodes gérés " ;  
$LANG['config_comment_jourshorsperiodetype'] = "// le type des jours conges normaux (sur lequel sont comptés les hors périodes) " ;  
$LANG['config_comment_jourshorsperiode-ouvert'] = "// si True on peut saisir/modifier les jours hors -periodes sans contrainte de date " ;  
...
$LANG['calcul_nb_jours_commentaire_bad_date2']	= "attention: vérifier saisie am/pm !";
...
$LANG['divers_valider'] = "ok; veuillez valider votre demande" ; 
// CONFIG
...
// VERIF SOLDE POSITIF
$LANG['verif_solde_erreur_part_1']	= "Attention: nombre de jours d'absence demandés";
$LANG['verif_solde_erreur_part_2']	= "supérieur au solde (solde net";
$LANG['verif_solde_erreur_part_3']	= "- congés à valider";

//autovalidation des congés par le responsable
$LANG['config_comment_autovalidation_par_responsable']	= "// AUTOVALIDATION DES CONGES PAR LE RESPONSABLE : <br>\n//--------------------------------------------------------------------------------------------<br>\n// si à FALSE : le responsable ne peut pas valider ses propres demandes de congés (FALSE est la valeur par defaut)<br>\n// si à TRUE : le responsable peut valider.";//modif du 26 oct 2012

# 16_Int_calendar integration_calendar  // 142ac2 
$LANG['config_comment_int_calendar'] = "// TRUE : necessaire pour que les mails portant les items calendar soit émis <br>\n//FALSE sinon "; 
$LANG['config_comment_calendar_tag'] = "// tag servant de préfixe au enregistrement calendar ; ce tag a la valeur UID:'calendar_tag'-'login'-'numperiode'; "; 
$LANG['config_comment_hdeb_periode_am'] = "// heure au format hhmmss debut de matinee"; 
$LANG['config_comment_hfin_periode_am'] = "// heure au format hhmmss fin   de matinee"; 
$LANG['config_comment_hdeb_periode_pm'] = "// heure au format hhmmss debut apres-midi"; 
$LANG['config_comment_hfin_periode_pm'] = "// heure au format hhmmss fin   apres-midi"; 
