...
# 
INSERT INTO `conges_config` VALUES ('url_conges_assistance', 'http://portail-dgac.aviation-civile.gouv.fr/portal/server.pt/gateway/PTARGS_0_57406_222_1854_57335_43/http%3B/collaboration%3B11930/collab/do/project/overview;jsessionid=4E3E4AAF0FD7F577894BABDB1C8725FC?projID=52894', '00_php_conges', 	'texte', 'config_comment_url_conges_assistance'); 
...
INSERT INTO `conges_config` VALUES ('calendar_tag', 'sigp-conges-sg', '16_Int_calendar', 'texte', 'config_comment_calendar_tag');
...
('mail_valid_conges', 'APPLI CONGES - Congé accepté __dpa ', ' __SENDER_NAME__ a enregistré/accepté ce congé pour vous dans l''application de gestion des congés:  \r\ndu __DATE_DEBUT__ au __DATE_FIN__ :  __NB_OF_DAY__  jour(s) de type __TYPE_ABSENCE__\r\n------------------------------\r\n__ABS_AS_CALITEM__\r\n------------------------------\r\nMerci de consulter votre application php_conges : __URL_ACCUEIL_CONGES__/\r\n\r\n-------------------------------------------------------------------------------------------------------\r\nCeci est un message automatique.'),
